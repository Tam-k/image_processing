...
image_path = R"C:\Users\class\Desktop\images\i17.jpg"
...
skin_S_mode_mean = recog.skin_identification(skin_H_list,skin_S_list,skin_V_list)   #肌結果出力用
...
white_eye_V = int(np.argmax(HSV_1[2],HSV_2[2]))
print(white_eye_V)
#黒目(書き換え多分終わり)
